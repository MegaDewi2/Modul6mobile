...
public class konfigurasi {
    ...
    public static final String URL_ADD = "http://192.168.1.10/db_android/insert.php";
    public static final String URL_GET_ALL = "http://192.168.1.10/db_android/read.php";
    public static final String URL_GET_MHS = "http://192.168.1.10/db_android/select.php?id=";
    public static final String URL_UPDATE_MHS = "http://192.168.1.10/db_android/update.php";
    public static final String URL_DELETE_MHS = "http://192.168.1.10/db_android/delete.php?id=";
